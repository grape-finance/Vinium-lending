...
contract UniswapLiquiditySwapAdapter is BaseUniswapAdapter {
   ...
   * The user should give this contract allowance to pull the ViTokens in order to withdraw the underlying asset and
  ...
  struct SwapAndDepositLocalVars {
    uint256 i;
    uint256 viTokenInitiatorBalance;
  ...
  function _swapLiquidity(
    ...
    _pullViToken(assetFrom, vars.viToken, initiator, vars.amountToPull, permitSignature);
