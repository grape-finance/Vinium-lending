...
contract ViToken is VersionedInitializable, IncentivizedERC20('VITOKEN_IMPL', 'VITOKEN_IMPL', 0), IViToken {
  ...
  /**
   * @dev Burns viTokens from `user` and sends the equivalent amount of underlying to `receiverOfUnderlying`
   * - Only callable by the LendingPool, as extra state updates there need to be managed
   * @param user The owner of the viTokens, getting them burned
  ...
  /**
   * @dev Mints `amount` viTokens to `user`
   * - Only callable by the LendingPool, as extra state updates there need to be managed
  ...
  /**
   * @dev Transfers viTokens in the event of a borrow being liquidated, in case the liquidators reclaims the viToken
   * - Only callable by the LendingPool
   * @param from The address getting liquidated, current owner of the viTokens
  ...
  /**
   * @dev calculates the total supply of the specific viToken
  ...
  /**
   * @dev Returns the address of the Vinium treasury, receiving the fees on this viToken
   **/
  ...
  /**
   * @dev Returns the address of the underlying asset of this viToken (E.g. WETH for aWETH)
   **/
  ...
  /**
   * @dev Returns the address of the lending pool where this viToken is used
   **/
   ...
   **/
  function _getIncentivesController() internal view override returns (IViniumIncentivesController) {
   ...
   **/
  function getIncentivesController() external view override returns (IViniumIncentivesController) {
   ...
   * @param target The recipient of the viTokens
  ...
  /**
   * @dev Invoked to execute actions on the viToken side after a repayment.
  ...
  /**
   * @dev Transfers the viTokens between two users. Validates the transfer
