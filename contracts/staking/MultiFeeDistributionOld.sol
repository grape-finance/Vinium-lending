...
contract MultiFeeDistributionOld is IMultiFeeDistribution, Ownable {
  ...
  function addReward(address _rewardsToken) external override {
    require(msg.sender == owner() || ((msg.sender == lendingPoolConfigurator) && lendingPoolConfigurator != address(0)));
