...
Used for the verification of the VariableVdToken contract.
*/
contract LendingPoolHarnessForVariableVdToken is ILendingPool {
  ...
  function liquidationCall(
    ...
    originalPool.liquidationCall(collateral, asset, user, debtToCover, receiveViToken);
  }
